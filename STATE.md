# PAL STATE
עודכן: 2026-08-06 (ארכיטקטורת v8: preflight/postflight, 96 כללים נאכפים, 2 הכרעות עורכיות)
...
|------|------|-------|------|
| content-machine | **v8.3** | מותקן. נהג של preflight/postflight | ריצת אימות ראשונה טרם בוצעה |
...
| pal-lint (tools/) | **v1.10.0** | selftest ירוק, 19 fixtures | 96 כללים |
| preflight.py (tools/) | v1.4 | חדש 2026-08-03 | שער כניסה. brief.json |
| postflight.py (tools/) | v1.1 | חדש 2026-08-03 | שער יציאה. 12 בדיקות |
| ledger_lint.py, version_guard.py | v1.0 | חדשים, ב-CI | |
