# PAL STATE
עודכן: 2026-08-16 (v8.18, pal-lint v1.14.0, version_guard v1.3, 8 שערי CI, שישה מקורות מדידה)
...
|------|------|-------|------|
| content-machine | **v8.18** | מותקן. נהג של preflight/postflight | ריצת אימות ראשונה בוצעה; מאמר Refresh פורסם 2026-08-10 |
