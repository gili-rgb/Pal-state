# PAL STATE
עודכן: 2026-08-16 (v8.15, pal-lint v1.13.0, 7 שערי CI, שישה מקורות מדידה)
...
|------|------|-------|------|
| content-machine | **v8.15** | מותקן. נהג של preflight/postflight | ריצת אימות ראשונה בוצעה; מאמר Refresh פורסם 2026-08-10 |
