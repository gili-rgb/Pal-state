...
|------|------|-------|------|
| content-machine | v7.14 | ZIP אצל גיל, ממתין להתקנה | בירור v7.10-v7.11 נסגר: התוכן שוחזר מהיסטוריית השיחות ושולב ב-v7.14; אין גרסאות אבודות |
| brand-hub-machine | v1.15 | מותקן ופעיל (אומת 2026-07-05) | 3 עמודים צריכים תיקון Product schema רטרו |
